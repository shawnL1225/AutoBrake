...
public class example {
	...
	public static void main(String[] args) {
		...
		// Create and configuration the windows
		JFrame window = new JFrame();
		window.setTitle("AutoBrake_computerSite_System");
		...
		for(int i = 0; i < portNames.length; i++)	portList.addItem(portNames[i].getSystemPortName());
